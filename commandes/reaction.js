      ...
      const cards = [
        {
          header: {
            ...
            videoMessage: (await generateWAMessageContent({ video: videoBuffer, gifPlayback: true }, { upload: zk.waUploadToServer })).videoMessage,
          },
          body: {
        ...
        },
        {
          header: {
            ...
            hasMediaAttachment: true,
            videoMessage: (await generateWAMessageContent({ video: videoBuffer2, gifPlayback: true }, { upload: zk.waUploadToServer })).videoMessage,
          },
          body: {
            text: `Check out this ${reactionName} reaction!`,
          },

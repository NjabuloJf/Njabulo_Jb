...
fana({ 
  ...
  try {
    ...
    const audioUrl = googleTTS.getAudioUrl(response, { lang: voiceLanguage, slow: false });
    await zk.sendMessage(chatId, { audio: { url: audioUrl }, mimetype: 'audio/mpeg', ptt: true }, { quoted: ms });
  } catch (err) {

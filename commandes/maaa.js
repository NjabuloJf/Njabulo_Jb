...
fana({ nomCom: "meenu", categorie: "General" }, async (dest, zk, commandeOptions) => {
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          mediaUrl: 'https://www.instagram.com/njabulojb871',
      ...
      nativeFlowMessage: {
        ...
        messageParamsJson: JSON.stringify({
          limited_time_offer: {
            ...
            url: 'https://github.com/Fred1e/Fee-Xmd',
            copy_code: 'FREDI',
            expiration_time: Date.now() + (60 * 60 * 1000), // expires in 1 hour
          },
          bottom_sheet: {
            in_thread_buttons_limit: 2,
            divider_indices: [1, 2],

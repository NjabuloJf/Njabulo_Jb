...
zk.on('message', async (message) => {
  if (message.type === 'interactive_message' && message.interactiveMessage.nativeFlowMessage) {
    const buttonId = message.interactiveMessage.nativeFlowMessage.buttons[0].buttonParamsJson.id;

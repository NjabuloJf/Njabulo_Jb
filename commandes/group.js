  ...
  async (dest, zk, commandeOptions) => {
    ...
    if (!(superUser || verifAdmin)) {
      return sendFormattedMessage(
        zk,
        dest,
        "σrdєr rєsєrvєd fσr thє αdmínístrαtσrr",
        ms
      );
    }
    ...
    switch (option) {
      case "open":
        ...
        sendFormattedMessage(zk, dest, "group open", ms);
        break;
      case "close":

...
module.exports = { session: process.env.SESSION_ID || 'zokk',
    ...
    GITHUB : process.env.GITHUB|| 'https://files.catbox.moe/mh36c7.jpg',
   ...
   AUTO_SAVE_CONTACTS : process.env.AUTO_SAVE_CONTACTS || 'yes',
    ...
    URL: process.env.URL || "https://files.catbox.moe/mh36c7.jpg",  
    ...
    TIMEZONE: process.env.TIMEZONE || "Africa/Botswana", 
